...
// the underlying endpoint. For example, "GET" requests to the [TIME_SERIES_DAILY_ADJUSTED](https://www.alphavantage.co/documentation/#dailyadj)
// endpoint will be created using the GetTimeSeriesDaily method once the
// Service receiver has been created using the desired input parameters.